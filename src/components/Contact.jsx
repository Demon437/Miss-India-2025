    ...
    <div className="p-8 bg-white rounded-xl shadow-lg border-2 border-[#d6ac45]/20 hover:border-[#d6ac45]/40 hover:shadow-xl transition-all duration-300 w-full group">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="text-left">
          ...
          <p className="text-xl text-dark-700 leading-relaxed group-hover:text-dark-800 transition-colors duration-300">
        ...
        <div className="text-left">
          ...
          <div className="space-y-4">
            <div className="flex items-center hover:text-[#d6ac45] transition-colors duration-200">
              ...
              <span className="text-xl text-dark-700 group-hover:text-dark-800 transition-colors duration-300">Phone: +91-XXXXXXXXXX</span>
            </div>
            <div className="flex items-center hover:text-[#d6ac45] transition-colors duration-200">
              <span className="text-2xl mr-3">✉️</span>
              <span className="text-xl text-dark-700 group-hover:text-dark-800 transition-colors duration-300">Email: info@brightstage.com</span>
            </div>
            <div className="flex items-center hover:text-[#d6ac45] transition-colors duration-200">
              <span className="text-2xl mr-3">🌐</span>
              <span className="text-xl text-dark-700 group-hover:text-dark-800 transition-colors duration-300">Website: www.brightstage.com</span>
            </div>
          </div>
        </div>
      </div>
